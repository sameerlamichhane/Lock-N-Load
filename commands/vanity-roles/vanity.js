...
async function sendHelpEmbed(client, message) {
  ...
  const helpEmbed = new MessageEmbed()
    ...
    .addField(`<a:arrow_right:1133392521297399960> \`vanity config\``, `Shows vanity role settings for the server.`)
    .addField(`<a:arrow_right:1133392521297399960> \`vanity guide\``, `Shows the guide for vanity role settings.`)
    .addField(`<a:arrow_right:1133392521297399960> \`vanity set role <role>\``, `Setups vanity role settings for the server.`)
    .addField(`<a:arrow_right:1133392521297399960> \`vanity set vanity <vanity>\``, `Setups vanity role link settings for the server.`)
    .addField(`<a:arrow_right:1133392521297399960> \`vanity set channel <channel>\``, `Setups vanity role settings for the server.`)
    .addField(`<a:arrow_right:1133392521297399960> \`vanity reset\``, `Resets vanity role for the server.`)
...
async function sendConfigEmbed(client, message) {
  ...
  const configEmbed = new MessageEmbed()
    ...
    .addField(`<a:arrow_right:1133392521297399960> Vanity Role:`, vanityRole === 'Not set' ? '`Not set`' : `<@&${vanityRole}>`)
    .addField(`<a:arrow_right:1133392521297399960> Vanity URL:`, vanityURL === 'Not set' ? '`Not set`' : `.gg/${vanityURL}`)
    .addField(`<a:arrow_right:1133392521297399960> Vanity Channel:`, vanityChannel)
    .setFooter(`Made by ${arypton.username} with 💞`, `${arypton.displayAvatarURL({ dynamic: true })}`);
